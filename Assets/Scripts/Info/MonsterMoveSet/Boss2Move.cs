...
public class Boss2Move : BossMove
{
    ...
    protected override void MoveObject()
    {
        ...
        if (MovingToTarget)
        {
            transform.position = Vector3.MoveTowards(transform.position, PositionB, MoveSpeed);
        ...
        {
            // 특정 좌표A로 이동 중이면
            transform.position = Vector3.MoveTowards(transform.position, PositionA, MoveSpeed);
